 ...
 */
#define stackOpen(this, path, oflags, mode)       				invoke(Open, this, path, oflags, mode)
...
#define stackClose(this)      									invokeNoParms(Close, this) /* TODO: save error and restore */
...
void *pagedNew(ssize_t suggestedSize, void *next);
...
void *aeadNew(char *cipherName, size_t suggestedSize, Byte *key, size_t keyLen, uint64 (*getSequenceNr)(), void *next);
