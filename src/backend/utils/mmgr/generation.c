						...
						Size maxBlockSize)
{
	 ...
	 */
	set = (GenerationContext *) malloc_reserved(allocSize, PG_ALLOC_GENERATION);
	if (set == NULL)
	{
...
GenerationReset(MemoryContext context)
{
	...
	unreserve_memory(deallocation, PG_ALLOC_GENERATION);
...
GenerationAlloc(MemoryContext context, Size size)
{
	...
	if (chunk_size > set->allocChunkLimit)
	{
		...
		block = (GenerationBlock *) malloc_reserved(blksize, PG_ALLOC_GENERATION);
		if (block == NULL)
			return NULL;
