...
CREATE VIEW pg_memory_reservation AS
    SELECT * FROM pg_stat_get_memory_reservation();

CREATE VIEW pg_backend_memory_reservation AS
    SELECT * from pg_stat_get_backend_memory_reservation();

CREATE VIEW pg_global_memory_tracking AS
